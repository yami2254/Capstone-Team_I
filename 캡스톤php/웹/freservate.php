...
$query2 = "insert into Reservate_state(R_Uid,R_SRid,R_SRname,R_starttime,R_usetime,R_date,R_free,R_first_id,R_use) VALUES('$userid','$rstudy','$rsname','$rstart','$rtimee','$rdatee',1,1,'$ruse') ";
