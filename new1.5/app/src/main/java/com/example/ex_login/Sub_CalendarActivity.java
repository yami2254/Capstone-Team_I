    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataSelected(AdapterView parent, View v, int position, long id) {
                ...
                if (  curDay + 7 <=  Calendar.getInstance().getActualMaximum(Calendar.DATE)) {
                    if (curItem.getDay() >= curDay && curItem.getDay() < curDay + 8  && curMonth+1 == RealMonth) {
                        flag = true;
                        String RealMonth2 = String.format("%02d",curMonth + 1);
                        changedate = curYear + "년 " + RealMonth2+ "월 " + String.format("%02d", curItem.getDay()) + "일";
                    } else {
                        flag = false;
                        String RealMonth2 =  String.format("%02d",RealMonth);
                        changedate = curYear + "년 " + RealMonth2 + "월 " + String.format("%02d",curDay) + "일";
                    }
                }
                else
                {
        ...
        okbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectflag == false)
                    changedate  = curYear + "년 " + String.format("%02d",RealMonth) + "월 " + String.format("%02d",curDay) + "일";
